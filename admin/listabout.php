						...
						<table data-toggle="table" border="2">
						    ...
						    <tbody>
						    	<?php
									...
									<td> <?php echo $value->twt_link ; ?> </td>
									<td> <?php echo $value->insta_link ; ?> </td>
									...
									<td> <?php 
													{
														echo "<a  class='btn btn-primary' href='updateabout.php?id=".$value->id."'>Update</a>"."&nbsp"; 
														echo "<a class='btn btn-danger' href='deleteabout.php?id=".$value->id."'>Delete</a>";
													}
											?>
