						...
						<table data-toggle="table" border="2">
						    ...
						    <tbody>
						    	<?php
									...
									$data = $testimonial->selecttestimonial(); 
									...
									<td> <?php 
													{
														echo "<a  class='btn btn-primary' href='updatetestimonial.php?id=".$value->id."'>Update</a>"."&nbsp"; 
														echo "<a class='btn btn-danger' href='deletetestimonial.php?id=".$value->id."'>Delete</a>";
													}
											?>
